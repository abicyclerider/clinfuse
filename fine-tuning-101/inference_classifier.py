...
def load_model(model_id=MODEL_ID, quantize_4bit=True):
...
def main():
    ...
    if not torch.cuda.is_available():
        print("ERROR: CUDA required. bitsandbytes 4-bit does not work on CPU/MPS.")
        print("Run this on a CUDA GPU (RunPod, Colab, etc.)")
        sys.exit(1)
